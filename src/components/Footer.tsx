        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2.5 mb-6">
              <li>
                <a href={`/${locale}/privacy`} className="text-sm text-muted transition-colors hover:text-peach">
                  {t("links.privacy")}
                </a>
              </li>
              <li>
                <a href={`/${locale}/terms`} className="text-sm text-muted transition-colors hover:text-peach">
                  {t("links.terms")}
                </a>
              </li>
            </ul>
